...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.poloburger.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.poloburger.app.security.DomainUserDetailsService", "createSpringSecurityUser");
